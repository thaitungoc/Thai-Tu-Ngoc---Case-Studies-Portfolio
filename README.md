...
# F&B Startup Strategy & Operations (Personal Project)
...
Thiết kế bảng tính CAPEX/OPEX chi tiết để quản lý ngân sách đầu tư.
...
**Impact:** Hoàn thiện bộ hồ sơ thiết lập dự án sẵn sàng vận hành, tối ưu hóa 15% chi phí mua sắm thông qua đàm phán nhà cung cấp dựa trên dữ liệu.
